...
// Precision-tuned to follow continental shelves more closely
const LAND_REGIONS = [
  // North America
  { name: 'NA - US East Coast', minLat: 24, maxLat: 46, minLng: -82, maxLng: -70 },
  { name: 'NA - Canada East', minLat: 45, maxLat: 60, minLng: -90, maxLng: -53 },
  { name: 'NA - US Central', minLat: 24, maxLat: 49, minLng: -105, maxLng: -82 },
  { name: 'NA - US West', minLat: 32, maxLat: 49, minLng: -126, maxLng: -105 },
  { name: 'NA - Mexico/CA', minLat: 7, maxLat: 32, minLng: -116, maxLng: -77 },
  { name: 'NA - Interior', minLat: 20, maxLat: 72, minLng: -130, maxLng: -60 }, // Backup
  
  // South America
  { name: 'SA - East Coast', minLat: -30, maxLat: 5, minLng: -55, maxLng: -34 },
  { name: 'SA - West/Interior', minLat: -56, maxLat: 13, minLng: -82, maxLng: -55 },

  // Eurasia
  { name: 'Europe - West/Main', minLat: 36, maxLat: 62, minLng: -11, maxLng: 25 },
  { name: 'Europe - East/Central', minLat: 40, maxLat: 72, minLng: 25, maxLng: 45 },
  { name: 'Europe - Scandinavia', minLat: 55, maxLat: 71, minLng: 4, maxLng: 32 },
  { name: 'Asia - Middle East', minLat: 12, maxLat: 40, minLng: 35, maxLng: 65 },
  { name: 'Asia - India', minLat: 7, maxLat: 35, minLng: 67, maxLng: 92 },
  { name: 'Asia - China/East', minLat: 18, maxLat: 55, minLng: 98, maxLng: 130 },
  { name: 'Asia - Interior', minLat: 15, maxLat: 75, minLng: 40, maxLng: 170 },
  { name: 'Asia - SE Mainland', minLat: 1, maxLat: 25, minLng: 95, maxLng: 110 },
  { name: 'Asia - SE Islands', minLat: -11, maxLat: 8, minLng: 95, maxLng: 155 },
  { name: 'Asia - Japan', minLat: 30, maxLat: 46, minLng: 128, maxLng: 147 },

  // Africa
  { name: 'Africa - North', minLat: 15, maxLat: 37, minLng: -18, maxLng: 32 },
  { name: 'Africa - Interior', minLat: -35, maxLat: 37, minLng: -20, maxLng: 52 },
  { name: 'Africa - West Tight', minLat: 4, maxLat: 15, minLng: -18, maxLng: 10 },
  { name: 'Africa - East Tight', minLat: -15, maxLat: 15, minLng: 35, maxLng: 51 },

  // Australia
  { name: 'Australia - Main', minLat: -44, maxLat: -10, minLng: 112, maxLng: 154 }
];

// Defined maritime corridors (Canals, straits, and semi-enclosed seas where ships must stay blue)
// These act as "safe water" overrides against land detection bounding boxes.
const CANAL_ZONES = [
  { name: 'Suez Canal / Red Sea North', lat: 28.0, lng: 33.5, radius: 400 },
  { name: 'Red Sea Central', lat: 20.0, lng: 38.5, radius: 600 },
  { name: 'Red Sea South / Bab al-Mandeb', lat: 13.0, lng: 43.0, radius: 300 },
  { name: 'Gulf of Aden', lat: 12.5, lng: 50.0, radius: 500 },
  { name: 'Mediterranean West', lat: 37.0, lng: 3.0, radius: 700 },
  { name: 'Mediterranean Central', lat: 35.0, lng: 16.0, radius: 600 },
  { name: 'Mediterranean East', lat: 34.0, lng: 30.0, radius: 600 },
  { name: 'Panama Canal', lat: 9.1, lng: -79.7, radius: 100 },
  { name: 'Malacca Strait', lat: 1.3, lng: 102.8, radius: 250 },
  { name: 'Strait of Gibraltar / Alboran Sea', lat: 36.0, lng: -4.0, radius: 300 },
  { name: 'Strait of Hormuz / Persian Gulf', lat: 26.6, lng: 54.0, radius: 250 },
  { name: 'English Channel', lat: 50.5, lng: -0.5, radius: 200 },
  { name: 'Bay of Bengal', lat: 15.0, lng: 90.0, radius: 800 },
